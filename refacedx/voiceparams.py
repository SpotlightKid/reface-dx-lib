...
params_op = (
    ...
    (0x09, 1, int, "op_eg_ksc_rate", (0, 127), None,
     "Operator EG Keyboard Rate Scaling"),
    (0x0a, 1, int, "op_eg_ksc_level_depth_l", (0, 127), None,
     "Operator EG Keyboard Level Scaling Depth Left"),
    (0x0b, 1, int, "op_eg_ksc_level_depth_r", (0, 127), None,
     "Operator EG Keyboard Level Scaling Depth Right"),
    (0x0c, 1, int, "op_eg_ksc_level_curve_l", (0, 3), ksc_level_curve,
     "Operator EG Keyboard Level Scaling Curve Left"),
    (0x0d, 1, int, "op_eg_ksc_level_curve_r", (0, 3), ksc_level_curve,
     "Operator EG Keyboard Level Scaling Curve Right"),
    (0x0e, 1, int, "op_lfo_amd", (0, 127), None,
     "LFO Operator Amplitude Modulation Depth"),
    (0x0f, 1, bool, "op_lfo_pm_enable", (0, 1), None,
     "LFO Operator Pitch Modulation On/Off"),
    (0x10, 1, bool, "op_peg_pm_enable", (0, 1), None,
     "Pitch EG Operator Pitch Modulation On/Off"),
    (0x11, 1, int, "op_leveL_velocity_sens", (0, 127), None,
     "Operator Level Velocity Sensitivity"),
